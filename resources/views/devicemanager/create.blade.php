...
<div class="grid grid-cols-1 gap-6 relative">
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6 shadow-sm">
        ...
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h3 class="text-lg font-bold text-gray-800 dark:text-white/90">Tambah Perangkat IoT</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Silakan isi formulir di bawah ini untuk menambahkan data perangkat/sensor baru.</p>
            </div>
        ...
        <!-- Form -->
        <form action="{{ route('devicemanager.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50/50 dark:bg-gray-800/20 p-5 rounded-xl border border-gray-100 dark:border-gray-800 mb-8"> 
                ...
                <div>
                    ...
                    <input type="text" id="nama_perangkat" name="nama_perangkat" placeholder="Contoh: Sensor Gudang A" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-3 text-sm text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-1 dark:border-gray-700 dark:text-white/90 shadow-sm" required />
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="lokasi" name="lokasi" placeholder="Contoh: Gedung 1 Lt. 2" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-3 text-sm text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-1 dark:border-gray-700 dark:text-white/90 shadow-sm" required />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-brand-50/30 dark:bg-brand-500/5 p-5 rounded-xl border border-brand-100 dark:border-brand-500/20">
                ...
                <div>
                    ...
                    <input type="text" id="mac_address" name="mac_address" placeholder="Contoh: 24:0A:C4:00:01:10" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-3 text-sm text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-1 dark:border-gray-700 dark:text-white/90 shadow-sm uppercase font-mono" required />
                </div>
                ...
                <div>
                    ...
                    <div class="relative shadow-sm rounded-lg">
                        ...
                        <input type="number" step="0.1" id="threshold_suhu" name="threshold_suhu" placeholder="Contoh: 30.0" value="30.0" class="w-full rounded-lg border border-gray-300 bg-transparent pl-11 pr-4 py-3 text-sm text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-1 dark:border-gray-700 dark:text-white/90 font-mono" required />
                    </div>
            ...
            <div class="mt-6">
                ...
                <textarea id="keterangan" name="keterangan" rows="3" placeholder="Tambahkan catatan khusus untuk perangkat ini..." class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-3 text-sm text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-1 dark:border-gray-700 dark:text-white/90 shadow-sm"></textarea>
            </div>
