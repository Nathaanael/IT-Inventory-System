        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <form id="searchForm" action="{{ route('devicemanager.index') }}" method="GET" class="flex flex-wrap sm:flex-nowrap gap-3">
                        <div class="relative flex-1 sm:w-64">
                            <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari perangkat..." class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 focus:border-brand-500 focus:outline-none dark:border-gray-700 dark:text-white/90 dark:focus:border-brand-500" />
