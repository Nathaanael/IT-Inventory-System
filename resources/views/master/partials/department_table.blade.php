<div class="overflow-x-auto overflow-y-auto max-h-[500px] rounded-lg border border-gray-200 dark:border-gray-800 relative">
    <table class="w-full table-auto">
        <thead class="text-left">
            <tr>
                <th class="sticky top-0 z-10 bg-gray-50 dark:bg-gray-800 px-5 py-3 text-sm font-semibold text-gray-800 dark:text-white/90 shadow-[0_1px_0_0_#e5e7eb] dark:shadow-[0_1px_0_0_#1f2937]">Nama Departemen</th>
            ...
            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/20 transition-colors">
                ...
                <td class="px-5 py-4 text-center">
                    <div class="flex items-center justify-center gap-3">
                        <button @click="$dispatch('open-modal', { action: 'edit', id: {{ $department->id }}, name: '{{ addslashes($department->name) }}' })" class="text-blue-500 hover:text-blue-700 transition-colors" title="Edit Data">
